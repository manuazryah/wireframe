...
/**
 * DpsSearch represents the model behind the search form about `common\models\Dps`.
 */
class DpsSearch extends Dps
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['online_refrerence_number', 'payment_receipt', 'approval_fees_receipt', 'police_report', 'approval_certificate', 'date', 'next_step', 'comment'], 'safe'],
