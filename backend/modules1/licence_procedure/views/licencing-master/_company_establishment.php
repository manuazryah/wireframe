                            ...
                            <div class="card">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="step1">
                                        <h3 class="heading">Company Establishment Card</h3>
                                            ...
                                            <div class="form-box">
                                                ...
                                                <div class="row">
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
                                                        <?= $form->field($model, 'license')->fileInput(['class' => 'form-control', 'autofocus' => 'true']) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    
                                                        <?= $form->field($model, 'typing_service')->textInput(['maxlength' => true]) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'service_reciept')->fileInput(['class' => 'form-control']) ?>
                                                    ...
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'payment_reciept')->fileInput(['class' => 'form-control']) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'card_attachment')->fileInput(['class' => 'form-control']) ?>
