...
$this->title = 'Contract Expiry Report';
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Contract Expired [From - To] </label>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div style="display: inline-flex;float: left; margin-top: 25px;">
                                ...
                                <?= Html::a('Reset', ['/reports/reports/contract-expiry'], ['class' => 'btn btn-danger', 'style' => 'display:block;margin-left:10px;']) ?>
                            </div>
                        </div>
                    </div>
                    <?php ActiveForm::end(); ?>
