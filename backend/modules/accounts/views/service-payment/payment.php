...
//									if ($previous_cheque->status == 2) {
									echo Html::dropDownList('status', $cleared_cheque->status, ['1' => 'Cleared', '2' => 'Bounced'], ['class' => 'cheque_payment', 'id' => $cleared_cheque->id, 'prompt' => '--Change Status--']);
//									}
									?></td>
							</tr>
							<?php
					...
					foreach ($previous_cheques as $previous_cheque) {
						if (!empty($previous_cheque)) {
							...
							<tr>
								...
								<td><?php
//									if ($previous_cheque->status == 2) {
									echo Html::dropDownList('status', $previous_cheque->status, ['1' => 'Cleared', '2' => 'Bounced'], ['class' => 'cheque_payment', 'id' => $previous_cheque->id, 'prompt' => '--Change Status--']);
//									}
									?></td>
							</tr>
							<?php
