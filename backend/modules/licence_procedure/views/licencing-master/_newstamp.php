            ...
            <div class="test-form form-inline">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <section id="tabs">
                            <div class="card">
                                <?= common\components\LicenseProcedureTabWidget::widget(['id' => $license_master->id, 'step' => 5]) ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="step1">
                                            ...
                                            <div class="form-box">
                                                ...
                                                <div class="row">
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    
                                                        <?= $form->field($model, 'payment')->textInput(['maxlength' => true, 'autofocus' => 'true']) ?>
                                        ...
                                        <div class="next-step">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pad-0 fright">
                                                <?= Html::a('<span> Completed and procced to next</span>', ['company-establishment-card', 'id' => $license_master->id], ['class' => 'button green']) ?>
                                            </div>
