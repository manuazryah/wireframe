                                            ...
                                            <div class="form-box">
                                                ...
                                                <div class="row">
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    
                                                        <?= $form->field($model, 'online_refrerence_number')->textInput(['maxlength' => true, 'autofocus' => 'true']) ?>
                                                    ...
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    
                                                        <?= $form->field($model, 'sira_approval_fees')->textInput(['maxlength' => true]) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'approval_fees_receipt')->fileInput(['class' => 'form-control']) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'police_report')->fileInput(['class' => 'form-control']) ?>

                                                    </div>
                                                    <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>  
                                                        <?= $form->field($model, 'approval_certificate')->fileInput(['class' => 'form-control']) ?>
